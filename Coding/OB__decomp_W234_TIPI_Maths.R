...
# TIPI Maths W2 - Junior Cert
library(oaxaca)

Oaxaca_Maths_TIPI_W2 <- oaxaca(
  JC_Maths_Points ~ 
...
print(Oaxaca_Maths_TIPI_W2)


# TIPI Maths W3 - Leaving Cert

Oaxaca_Maths_TIPI_W3 <- oaxaca(
  LC_Maths_Points ~ 
...
print(Oaxaca_Maths_TIPI_W3)


# Comparison plots

coef_df_Oaxaca_Maths_TIPI_W2 <- data.frame(
  variable = names(Oaxaca_Maths_TIPI_W2$beta$beta.diff),
  coefficient = Oaxaca_Maths_TIPI_W2$beta$beta.diff
)

ggplot(coef_df_Oaxaca_Maths_TIPI_W2, 
...
coef_df_Oaxaca_Maths_TIPI_W3 <- data.frame(
  variable = names(Oaxaca_Maths_TIPI_W3$beta$beta.diff),
  coefficient = Oaxaca_Maths_TIPI_W3$beta$beta.diff
)

ggplot(coef_df_Oaxaca_Maths_TIPI_W3, 
       aes(x = reorder(variable, coefficient), y = coefficient)) +
  geom_col() +
  coord_flip() +
...
Oaxaca_Maths_TIPI_W2_std <- oaxaca(
...
print(Oaxaca_Maths_TIPI_W2_std)


# TIPI Maths W3 - Leaving Cert

Oaxaca_Maths_TIPI_W3_std <- oaxaca(
...
print(Oaxaca_Maths_TIPI_W3_std)


# Comparison plots

coef_df_Oaxaca_Maths_TIPI_W2_std <- data.frame(
  variable = names(Oaxaca_Maths_TIPI_W2_std$beta$beta.diff),
  coefficient = Oaxaca_Maths_TIPI_W2_std$beta$beta.diff
)

ggplot(coef_df_Oaxaca_Maths_TIPI_W2_std, 
       aes(x = reorder(variable, coefficient), y = coefficient)) +
  geom_col() +
  coord_flip() +
...
coef_df_Oaxaca_Maths_TIPI_W3_std <- data.frame(
  variable = names(Oaxaca_Maths_TIPI_W3_std$beta$beta.diff),
  coefficient = Oaxaca_Maths_TIPI_W3_std$beta$beta.diff
)

ggplot(coef_df_Oaxaca_Maths_TIPI_W3_std, 
       aes(x = reorder(variable, coefficient), y = coefficient)) +
  geom_col() +
  coord_flip() +
...
wave2_subset_Maths_TIPI <- Oaxaca_Blinder %>%
...
wave3_subset_Maths_TIPI <- Oaxaca_Blinder %>%
  select(ID, LC_Maths_Points, Cog_Naming_Total_W3, Cog_Maths_Total_W3, Cog_Vocabulary_W3,
         TIPI_Extra_PCG_W3, TIPI_Agreeable_PCG_W3, TIPI_Cons_PCG_W3, TIPI_EmoStab_PCG_W3, TIPI_Open_PCG_W3,
         PCG_Educ_W3, SCG_Educ_W3, Income_Quin_Eq_W3, DEIS_W3, Fee_Paying_W3, Mixed_W3, Gender_YP_W3)

# Perform inner join
full_info_dataset_TIPI_Maths <- wave2_subset_Maths_TIPI %>%
  inner_join(wave3_subset_Maths_TIPI, by = "ID")

complete_info_dataset_TIPI_Maths <- full_info_dataset_TIPI_Maths %>%
  filter(complete.cases(.))

print(paste("Number of complete cases:", nrow(complete_info_dataset_TIPI_Maths)))

original_means <- Oaxaca_Blinder %>%
  summarise(across(c(JC_Maths_Points, LC_Maths_Points, Gender_YP_W2), mean, na.rm = TRUE))

complete_info_means <- complete_info_dataset_TIPI_Maths %>%
...
complete_info_dataset_TIPI_Maths <- complete_info_dataset_TIPI_Maths %>%
  mutate(JC_Maths_Standardized = scale(JC_Maths_Points),
         LC_Maths_Standardized = scale(LC_Maths_Points))
...
Oaxaca_Maths_TIPI_W2_std_COMPLETE <- oaxaca(
  JC_Maths_Standardized ~ 
    Cog_VR_W2 + Cog_NA_W2 + Cog_Matrices_W2 +
    TIPI_Extra_PCG_W2 + TIPI_Agreeable_PCG_W2 + TIPI_Cons_PCG_W2 + TIPI_EmoStab_PCG_W2 + TIPI_Open_PCG_W2 +
    PCG_Educ_W2 + SCG_Educ_W2 + Income_Quin_Eq_W2 + DEIS_W2 + Fee_Paying_W2 + Mixed_W2 | 
    Gender_YP_W2,
  data = complete_info_dataset_TIPI_Maths,
  R = 100  # Number of bootstrap replications
)

# TIPI Maths W3 - Leaving Cert

Oaxaca_Maths_TIPI_W3_std_COMPLETE <- oaxaca(
  LC_Maths_Standardized ~ 
    Cog_Naming_Total_W3 + Cog_Maths_Total_W3 + Cog_Vocabulary_W3 +
    TIPI_Extra_PCG_W3 + TIPI_Agreeable_PCG_W3 + TIPI_Cons_PCG_W3 + TIPI_EmoStab_PCG_W3 + TIPI_Open_PCG_W3 +
    PCG_Educ_W3 + SCG_Educ_W3 + Income_Quin_Eq_W3 + DEIS_W3 + Fee_Paying_W3 + Mixed_W3 | 
...
coef_df_Oaxaca_Maths_TIPI_W2_std_COMPLETE <- data.frame(
  variable = names(Oaxaca_Maths_TIPI_W2_std_COMPLETE$beta$beta.diff),
  coefficient = Oaxaca_Maths_TIPI_W2_std_COMPLETE$beta$beta.diff
)

ggplot(coef_df_Oaxaca_Maths_TIPI_W2_std_COMPLETE, 
       aes(x = reorder(variable, coefficient), y = coefficient)) +
  geom_col() +
  coord_flip() +
...
coef_df_Oaxaca_Maths_TIPI_W3_std_COMPLETE <- data.frame(
  variable = names(Oaxaca_Maths_TIPI_W3_std_COMPLETE$beta$beta.diff),
  coefficient = Oaxaca_Maths_TIPI_W3_std_COMPLETE$beta$beta.diff
)

ggplot(coef_df_Oaxaca_Maths_TIPI_W3_std_COMPLETE, 
       aes(x = reorder(variable, coefficient), y = coefficient)) +
  geom_col() +
  coord_flip() +
...
write.csv(complete_info_dataset_TIPI_Maths, 
          file = "C:/Users/bgiet/OneDrive/Documents/GitHub/ConflictingForces/ConflictingForces/sensitive_files/ConflictingForcesSensitive/complete_info_dataset_TIPI_Maths.csv", 
          row.names = FALSE)
