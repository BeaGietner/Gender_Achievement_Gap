Oaxaca_English_total_TIPI <- oaxaca(
  LC_English_Points ~ 
...
coef_df <- data.frame(
  variable = names(Oaxaca_English_total_TIPI$beta$beta.diff),
  coefficient = as.numeric(Oaxaca_English_total_TIPI$beta$beta.diff)
)
