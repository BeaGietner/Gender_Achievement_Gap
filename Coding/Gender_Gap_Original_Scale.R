...
# Data Preparation for Junior Cert (JC)
...
calculate_gender_gap_JC <- function(means) {
  ...
  data.frame(
    Maths_Gap_JC = female_means_JC$JC_Maths_Points - male_means_JC$JC_Maths_Points,
    English_Gap_JC = female_means_JC$JC_English_Points - male_means_JC$JC_English_Points
  )
}
...
# Data Preparation for Leaving Cert (LC)
...
calculate_gender_gap_LC <- function(means) {
  ...
  male_means_LC <- means %>% filter(Gender_YP_W3 == 1)
    ...
    data.frame(
      Maths_Gap_LC = female_means_LC$LC_Maths_Points - male_means_LC$LC_Maths_Points,
      English_Gap_LC = female_means_LC$LC_English_Points - male_means_LC$LC_English_Points
    )
  }
